...
export function resolveSslConfig() {
    const sslEnv = process.env.POSTGRES_SSL?.toLowerCase().trim();
...
export function resolvePostgresPoolConfig() {
    ...
    const port = Number.isFinite(parseInt(process.env.POSTGRES_PORT)) ? parseInt(process.env.POSTGRES_PORT) : 5432;
...
export const pgConfig = {
    ...
    options: resolvePostgresPoolConfig(),
